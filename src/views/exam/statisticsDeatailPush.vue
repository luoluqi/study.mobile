    ...
    <div>
            ...
            <div class="count-list">
                <div class="count-p">
                 ...
                 <div class="count-p">
                    ...
                    <div class="count-text">语文最高分</div>
                </div>
                 <div class="count-p">
                    <div class="count-num">{{statistisDetail.subjectAvgScore}}</div>
                    <div class="count-text">语文平均分</div>
                </div>
            </div>
        </div>
         <div class="count-item">
        ...
        <div class="chart-p">
            ...
            <div class="personalShow">
                ...
                <img :style="{left:scoreTotal}" src="./img/people.png" alt="">
            </div>
        </div>
...
export default {
    ...
    methods:{
        ...
        getScoreDetailsParent () {
            ...
            res => {
                if (res.Code == 200) {
                   this.scoreDetailsParents = res.Data
                }
            })
        },
        // 获取个人排名
...
.exam-k{position: absolute;width: 1.02rem;height: 0.48rem;line-height: 0.48rem;text-align: center; border-radius: 0.24rem;
